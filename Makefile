...
.PHONY: all
all: generate build manifests kustomize helmify helm
...
.PHONY: lint-fix
lint-fix: golangci-lint ## Run golFangci-lint linter and perform fixes
...
install: manifests kustomize ## Install CRDs into the K8s cluster specified in ~/.kube/config.
	$(KUSTOMIZE) build config/crd | $(KUBECTL) -v=8 apply -f - 
...
helm: manifests kustomize helmify
	$(KUSTOMIZE) build config/default | $(HELMIFY) charts/pipeline-operator